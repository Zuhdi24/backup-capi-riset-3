...
import org.odk.collect.android.pkl.network.OpenNotifHandler;
...
public class Collect extends Application {
    ...
    //tambahan
    public static final String host = "https://capi.pkl59.stis.ac.id";

    public static final String DEFAULT_FONTSIZE = "21";

    // share all session cookies acroshs all sessions...
    ...
    private OneSignal.Builder oneSignalBuilder = OneSignal.startInit(this);
    private static Collect singleton = null;
    private static boolean isDirectoryUpdated = false;
    ...
    public void setActivityLogger(ActivityLogger mActivityLogger) {
        this.mActivityLogger = mActivityLogger;
    }
    ...
    public static void setNewDirectory(String nim) {
        INSTANCES_PATH = INSTANCES_PATH + File.separator + nim;
        CACHE_PATH = CACHE_PATH + File.separator + nim;
        isDirectoryUpdated = true;
    }

    public static void setOldDirectory() {
    ...
    public static void createODKDirs() throws RuntimeException {
        ...
        String[] dirs = {
                ODK_ROOT, FORMS_PATH, INSTANCES_PATH, CACHE_PATH, METADATA_PATH, BRIEFCASE_PATH
        };
    ...
    */
    ...
    public OneSignal.Builder getOneSignalBuilder() {
        return oneSignalBuilder;
    }
...
//                mgr.getSingularProperty(PropertyManager.DEVICE_ID_PROPERTY));
        ...
        oneSignalBuilder
                ...
                .setNotificationOpenedHandler(OpenNotifHandler.getInstance(getApplicationContext()))
                .init();
    }

    //baru editan untuk volley
