...
public class AggregatePreferencesActivity extends PreferenceActivity {
    ...
    protected ListPreference mServerUrlPreference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actionBarTitle = getString(R.string.platform_settings);
        setTitle(actionBarTitle);

        mServerUrlPreference = (ListPreference) findPreference(PreferencesActivity.KEY_SERVER_URL);
