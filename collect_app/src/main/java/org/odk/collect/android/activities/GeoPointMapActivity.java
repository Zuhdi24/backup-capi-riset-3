 ...
 */
public class GeoPointMapActivity extends FragmentActivity implements LocationListener, OnMarkerDragListener, OnMapLongClickListener, OnMapReadyCallback {
    ...
    private ButtonRectangle mAcceptLocation;
    private ButtonRectangle mCancelLocation;
    private ButtonRectangle mReloadLocation;

    private boolean mCaptureLocation = true;
    private boolean mRefreshLocation = true;
    private boolean mIsDragged = false;
    private ButtonRectangle mShowLocation;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mCancelLocation = (ButtonRectangle) findViewById(R.id.cancel_location);
        ...
        mAcceptLocation = (ButtonRectangle) findViewById(R.id.accept_location);
        if (mCaptureLocation) {
        ...
        mReloadLocation = (ButtonRectangle) findViewById(R.id.reload_location);
        if (mCaptureLocation) {
        ...
        mShowLocation = ((ButtonRectangle) findViewById(R.id.show_location));
