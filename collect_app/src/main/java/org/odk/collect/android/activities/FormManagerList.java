...
public class FormManagerList extends ListActivity implements DiskSyncListener,
    ...
    private void createDeleteFormsDialog() {
        ...
        mAlertDialog.setMessage(getString(R.string.delete_confirm_kuesioner,
    ...
    private void deleteSelectedForms() {
        ...
        if (mBackgroundTasks.mDeleteFormsTask == null) {
            ...
            Toast.makeText(this, getString(R.string.file_delete_in_progress_kuesioner),
    ...
    public void deleteComplete(int deletedForms) {
        ...
        if (deletedForms == mSelected.size()) {
            ...
            Toast.makeText(getApplicationContext(),
                    getString(R.string.file_deleted_ok_kuesioner, String.valueOf(deletedForms)),
            ...
            Toast.makeText(
                    ...
                    getString(R.string.file_deleted_error_kuesioner, String.valueOf((mSelected.size()
