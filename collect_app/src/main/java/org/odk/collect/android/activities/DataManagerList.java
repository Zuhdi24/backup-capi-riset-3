...
public class DataManagerList extends ListActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        String selection = InstanceColumns.NIM + " = ?";
    ...
    private void createDeleteInstancesDialog() {
        ...
        mAlertDialog.setMessage(getString(R.string.delete_confirm_hasil,
                mSelected.size()));
    ...
    private void deleteSelectedInstances() {
        if (mDeleteInstancesTask == null) {
            ...
            Toast.makeText(this, getString(R.string.file_delete_in_progress_hasil),
    ...
    public void deleteComplete(int deletedInstances) {
        ...
        if (deletedInstances == mSelected.size()) {
            ...
            Toast.makeText(this,
                    getString(R.string.file_deleted_ok_hasil, deletedInstances),
            ...
            Toast.makeText(
                    this,
                    getString(R.string.file_deleted_error_hasil, mSelected.size()
